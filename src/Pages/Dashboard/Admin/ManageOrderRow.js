  ...
  const handleRemoveOrder = (id) => {
    ...
    return (
      <tr>
        ...
        <td>
          {
            order.paymentStatus === "paid" ? <span className="text-green-500">{order.paymentStatus}</span> : <span className="text-red-500">{order.paymentStatus}</span>
          }</td>
        <td>
            {
              order.orderStatus ? <span className="text-green-500">{order.orderStatus}</span> : <span className="text-red-500">{"pending"}</span>
            }
        </td>
