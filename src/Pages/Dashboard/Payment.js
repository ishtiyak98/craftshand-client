...
const stripePromise = loadStripe('pk_test_51L3ETmCy3s5eQvTMnzg5Mk2E2oycsIk9YUE8o61Wl60KPSBHpttqCk5QPO2CokchgCVkUCs87x6nyI5HwUTcegyI00W7orFGJF');
  ...
  return (
    <div className="mx-6 lg:mx-20">
      <div class="card w-full bg-base-100 shadow-xl">
        <div class="card-body">
            <div className="mb-10">
                <h2 className="text-2xl font-medium">Customer Name : {orderItem.customerName}</h2>
